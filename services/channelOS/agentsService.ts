...
const DEMO_REGISTRY: AgentsRegistry = {
  agents: [
    ...
    },
    {
      ...
      role: 'Refinamento',
      description:
        'Refina drafts existentes — ajusta tom, regenera beats fracos, aprova/arquiva. Não escreve do zero.',
      is_main: false,
      model: 'nousresearch/hermes-4-14b',
      model_chain: ['nousresearch/hermes-4-14b', 'anthropic/claude-sonnet-4.5'],
      allowed_tools: [
    ...
    },
    {
      ...
      role: 'Agendamento',
      description:
        'Agenda posts pra YouTube/TikTok/Instagram com horário ideal por plataforma. Upload OAuth virá na Phase 7.',
      is_main: false,
      model: 'nousresearch/hermes-4-14b',
      model_chain: ['nousresearch/hermes-4-14b', 'anthropic/claude-sonnet-4.5'],
      allowed_tools: [
    ...
    },
    {
      ...
      description:
        'Meta-agente: analisa atividade recente e propõe skills, automations, memory pins e mission templates pra você aprovar.',
      is_main: false,
      model: 'nousresearch/hermes-4.3-36b',
      model_chain: ['nousresearch/hermes-4.3-36b', 'anthropic/claude-sonnet-4.5'],
      allowed_tools: [
